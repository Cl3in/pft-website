...
theme:{
extend:{
colors:{brand:'<?php echo THEME_COLOR; ?>'}
}
}
}
</script>
...
<!-- EMAIL -->
<a href="mailto:info@parrishft.com"
...
<!-- MOBILE MENU -->
<div id="mobileMenu"
class="fixed top-0 right-0 h-full w-80 bg-[#1a1a1a]/95 backdrop-blur-md shadow-2xl
...
class="flex items-center gap-3 hover:text-red-500">
...
class="fa fa-chevron-down transition-transform"></i>

</button>


<div id="mobileServicesMenu"
class="overflow-hidden max-h-0 opacity-0 transition-all flex flex-col ml-6 gap-3">
...
<a href="/pft-website/pages/services/wideload.php"
class="flex items-center gap-3">
...
<i id="mobileResourcesIcon"
class="fa fa-chevron-down transition-transform"></i>

</button>


<div id="mobileResourcesMenu"
class="overflow-hidden max-h-0 opacity-0 transition-all flex flex-col ml-6 gap-3">
...
<a href="/pft-website/pages/contact.php"
class="bg-red-600 text-white px-5 py-2 rounded-full text-center mt-auto">
